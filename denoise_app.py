...
class DenoiseWidget(QWidget):
    ...
    def create_display_panel(self):
        ...
        self.denoise_metrics_text.setMaximumHeight(140)
        self.denoise_metrics_text.setMinimumHeight(120)
        ...
        self.sr_metrics_text.setMaximumHeight(140)
        self.sr_metrics_text.setMinimumHeight(120)
